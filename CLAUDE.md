...
- **`/code-decomposition`** — Guide for splitting complex code into focused units. Built on the Single Responsibility question ("what would cause this unit to change?"), applied fractally from a three-line function to a 500-line class to an entire module. Auto-triggers on refactor / "god class" / "long method" / "extract" / "split" / "拆一下" phrasing. Includes optional Swift-specific notes.
